...
export const CALCULATORS: Calculator[] = [
  ...
  // ==========================================
  { id: 'nepal-income-tax', slug: 'nepal-income-tax', name: 'Income Tax Calculator', icon: '📝', description: 'Income tax calculator for Nepal updated for latest fiscal year 2082/83.', category: 'nepal', isNepal: true, isHot: true, keywords: ['Nepal Income Tax Calculator 2082', 'IRD tax slabs 2082/83', 'salary tax Nepal', 'tax on bonus Nepal', 'social security tax', 'married tax slabs nepal', 'tax on investment nepal'] },
  { id: 'nepal-salary', slug: 'nepal-salary', name: 'Salary Calculator', icon: '💵', description: 'Calculate net take home salary with IRD deductions and SSF contributions.', category: 'nepal', isNepal: true, isNew: true, keywords: ['Salary Calculator Nepal', 'Net take home salary', 'IRD salary deductions', 'PF and CIT calculation', 'allowance tax', 'ssf nepal calculator', 'nepal payroll tool'] },
  { id: 'nepal-home-loan', slug: 'nepal-home-loan', name: 'Home Loan Calculator', icon: '🏠', description: 'Calculate home loan EMI with latest Nepal bank base rates and premiums.', category: 'nepal', isNepal: true, keywords: ['Home Loan EMI Nepal', 'NRB base rate', 'floating interest rate Nepal', 'housing loan eligibility', 'bank premium', 'nrb base rate 2082'] },
  { id: 'nea-bill', slug: 'nea-bill', name: 'Electricity Bill Calculator', icon: '⚡', description: 'Calculate Nepal Electricity Authority (NEA) progressive billing and unit slabs.', category: 'nepal', isNepal: true, isNew: true, keywords: ['NEA Bill Calculator', 'Nepal Electricity Authority tariffs', 'electricity slabs', 'NEA unit rates', 'penalty calculation', 'nepal electricity bill check'] },
  { id: 'nepal-land', slug: 'nepal-land', name: 'Land Area Converter', icon: '🏞️', description: 'Convert land area between Ropani, Aana, Bigha, and Square Feet with precision.', category: 'nepal', isNepal: true, isHot: true, isNew: true, keywords: ['Nepal Land Converter', 'Ropani to Bigha', 'Aana to Sq Ft converter', 'Khetmuri calculation', 'Dhur to Paisa', 'ropani aana paisa daam to sq ft', 'bigha kattha dhur to ropani'] },
  ...
  { id: 'nepal-tds', slug: 'nepal-tds', name: 'TDS Calculator', icon: '✂️', description: 'Calculate withholding tax for professional services and rent under IRD rules.', category: 'nepal', isNepal: true, isNew: true, keywords: ['TDS Rate Nepal', 'IRD withholding tax', '1.5% TDS professional', 'TDS on rent Nepal', 'TDS payment deadline', 'tds calculator nepal'] },
  { id: 'nepal-vehicle-tax', slug: 'nepal-vehicle-tax', name: 'Vehicle Tax Calculator', icon: '🚗', description: 'Calculate road tax and bluebook renewal fees for motorbikes and cars in Nepal.', category: 'nepal', isNepal: true, isNew: true, keywords: ['Vehicle Tax Nepal', 'Road tax motorbikes', 'car renewal fee Nepal', 'DoTM tax slabs', 'bluebook renewal', 'bike tax nepal 2082'] },
  ...
  { id: 'see-gpa', slug: 'see-gpa', name: 'SEE GPA Calculator', icon: '🅰️', description: 'Calculate SEE grade with all subject marks. Updated for 2082/2083 results and grading system.', category: 'nepal', isNepal: true, isNew: true, keywords: ['SEE Result 2082', 'SEE Result 2083', 'NEB grading system', 'SEE marks to GPA', 'GPA to percentage Nepal', 'see.ntc.net.np results', 'letter grading system nepal'] },
  { id: 'nepali-date', slug: 'nepali-date', name: 'Nepali Date Converter', icon: '📅', description: 'Standard BS to AD and AD to BS date conversion utility for Nepal.', category: 'nepal', isNepal: true, keywords: ['Nepali Date Converter', 'BS to AD converter', 'nepali calendar 2082'] },
  { id: 'nepal-vat', slug: 'nepal-vat', name: 'VAT Calculator', icon: '🔖', description: 'Calculate VAT (13%) addition and subtraction for Nepal trade.', category: 'nepal', isNepal: true, keywords: ['VAT Calculator Nepal', '13 percent vat calculation', 'vat bill nepal'] },
