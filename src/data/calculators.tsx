...
export const CALCULATORS: Calculator[] = [
  ...
  { id: 'bulk-nepali-date', slug: 'nepali-date/bulk', name: 'Bulk Nepali Date Converter', icon: '🗓️', description: 'Convert multiple Nepali dates (BS to AD) at once. Paste directly from Excel.', category: 'nepal', isNepal: true, isNew: true, keywords: ['Bulk Nepali Date Converter', 'convert multiple nepali dates', 'excel date converter nepal'] },
