...
export const CALCULATORS: Calculator[] = [
  ...
  { id: 'nepal-land', slug: 'nepal-land', name: 'Land Area Converter', icon: '', description: 'Convert land area between Ropani, Bigha, and Square Feet.', category: 'nepal', isNepal: true, isHot: true, keywords: ['bigha', 'kattha', 'ropani', 'aana', 'land converter', 'nepal land'] },
  ...
  { id: 'gold-converter', slug: 'gold-converter', name: 'Gold & Silver Converter', icon: '', description: 'Convert weight between Tola and Grams for Nepal markets.', category: 'nepal', isNepal: true, isNew: true, keywords: ['tola to gram', 'gold price nepal', 'lal to gram', 'silver tola'],
    steps: [
      'Select metal type.',
  ...
  { id: 'property-tax', slug: 'property-tax', name: 'Capital Gains Tax (CGT)', icon: '', description: 'Calculate real estate capital gains tax for Nepal.', category: 'nepal', isNepal: true, isNew: true, keywords: ['malpok tax', 'cgt nepal', 'property sales tax'] },
  ...
  { id: 'remittance-calculator', slug: 'remittance-calculator', name: 'Remittance Converter', icon: '', description: 'Convert foreign currency to NPR with live exchange rates.', category: 'nepal', isNepal: true, isHot: true, keywords: ['remittance today', 'usd to npr', 'ime rates', 'western union nepal'] },
  ...
  { id: 'foreign-employment', slug: 'foreign-employment', name: 'Foreign Employment Fees', icon: '', description: 'Check legal manpower and visa fees for Nepal.', category: 'nepal', isNepal: true, isNew: true, keywords: ['manpower fee', 'free visa free ticket', 'dofe nepal'] },
  ...
  { id: 'nepal-tds', slug: 'nepal-tds-calculator', name: 'TDS Calculator', icon: '', description: 'Calculate withholding tax for professional services.', category: 'nepal', isNepal: true, isNew: true },
  ...
  { id: 'see-gpa', slug: 'see-gpa', name: 'SEE GPA Calculator', icon: '', description: 'Calculate SEE grade point average.', category: 'nepal', isNepal: true, isNew: true },
  ...
  { id: 'mortgage-calculator', slug: 'mortgage-calculator', name: 'Mortgage Calculator', icon: '', description: 'Calculate home mortgage repayments.', category: 'finance' },
  { id: 'currency-converter', slug: 'currency-converter', name: 'Currency Converter', icon: '', description: 'Live global foreign exchange conversion.', category: 'finance' },
  ...
  { id: 'chemistry-molar', slug: 'chemistry-molar', name: 'Molar Mass Calculator', icon: '', description: 'Compute molar mass of molecular compounds.', category: 'engineering' },
  
  { id: 'standard-deviation', slug: 'standard-deviation', name: 'Standard Deviation', icon: '', description: 'Calculate statistical variance and standard deviation.', category: 'education' },
  ...
  { id: 'z-score', slug: 'z-score', name: 'Z-Score Calculator', icon: '', description: 'Calculate standardized z-scores for normal distributions.', category: 'education' },
  ...
  { id: 'ratio-proportion', slug: 'ratio-proportion', name: 'Ratio Calculator', icon: '', description: 'Calculate and simplify mathematical ratios.', category: 'education' },
  ...
  { id: 'roman-numerals', slug: 'roman-numerals', name: 'Roman Numerals', icon: '', description: 'Convert between Arabic numerals and Roman numeric strings.', category: 'education' },
  ...
  { id: 'concrete-mix', slug: 'concrete-mix', name: 'Concrete Mixer', icon: '', description: 'Calculate concrete volume and proportions.', category: 'engineering' },
  ...
  { id: 'weight-converter', slug: 'weight-converter', name: 'Weight Converter', icon: '', description: 'Convert mass units including grams, kilograms, and pounds.', category: 'utility', isNew: true },
  ...
  { id: 'discount-calculator', slug: 'discount-calculator', name: 'Discount Calculator', icon: '', description: 'Calculate retail discounting and pricing markups.', category: 'utility' },
  ...
  { id: 'solar-requirement', slug: 'solar-requirement', name: 'Solar Calculator', icon: '', description: 'Estimate photovoltaic capacity requirements.', category: 'utility', isNew: true },

  // ==========================================
  // HEALTH & FITNESS PILLAR
  // ==========================================
  { id: 'bmi', slug: 'bmi', name: 'BMI Calculator', icon: '', description: 'Calculate Body Mass Index (BMI) using WHO physiological standards.', category: 'health',
    steps: [
