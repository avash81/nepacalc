...
export const CALCULATORS: Calculator[] = [
  // ==========================================
  // NEPAL SPECIFIC PILLAR — ordered by traffic
  // NEA Bill (799), Vehicle Tax (682), KUKL (115), Land (6), Salary (38), TDS (32), Stocks (24), Property Reg (24)
  // ==========================================
  { id: 'nea-bill', slug: 'nea-bill', name: 'Nepal Electricity Bill Calculator 2083/84', icon: '⚡', description: 'Calculate Nepal Electricity Authority (NEA) progressive billing and unit slabs for 2083.', category: 'nepal', isNepal: true, isHot: true, keywords: ['NEA Bill Calculator', 'Nepal Electricity Authority tariffs', 'electricity slabs', 'NEA unit rates', 'penalty calculation', 'nepal electricity bill check'] },
  { id: 'nepal-vehicle-tax', slug: 'nepal-vehicle-tax', name: 'Vehicle Tax Calculator', icon: '🚗', description: 'Calculate road tax and bluebook renewal fees for motorbikes and cars in Nepal.', category: 'nepal', isNepal: true, isHot: true, keywords: ['Vehicle Tax Nepal', 'Road tax motorbikes', 'car renewal fee Nepal', 'DoTM tax slabs', 'bluebook renewal', 'bike tax nepal 2083'] },
  { id: 'kukl-bill', slug: 'kukl-bill', name: 'KUKL Water Bill', icon: '💧', description: 'Calculate Kathmandu Upatyaka Khanepani Limited (KUKL) bill and sewerage tax.', category: 'nepal', isNepal: true, isHot: true, keywords: ['KUKL Bill Calculator', 'Kathmandu water bill', 'water meter reading nepal'] },
  ...
  { id: 'kukl-payment', slug: 'water/kukl-bill-payment', name: 'KUKL Bill Payment Guide', icon: '📝', description: 'Complete guide to checking, paying, and downloading your KUKL water bill online.', category: 'nepal', isNepal: true, isNew: true, keywords: ['KUKL payment', 'pay kukl bill online', 'kukl esewa'] },
  ...
  { id: 'bulk-nepali-date', slug: 'calculator/nepali-date/bulk', name: 'Bulk Nepali Date Converter', icon: '🗓️', description: 'Convert multiple Nepali dates (BS to AD) at once. Paste directly from Excel.', category: 'nepal', isNepal: true, isNew: true, keywords: ['Bulk Nepali Date Converter', 'convert multiple nepali dates', 'excel date converter nepal'] },
  ...
  // ==========================================
  // MARKET RATES PILLAR — ordered by traffic
  // Gold Converter (351 clicks), Live Gold Price (238), Silver Converter (18), Exchange Rate (1), Currency (1), Remittance (0)
  // ==========================================
  { id: 'gold-converter', slug: 'gold-converter', name: 'Gold Unit Converter', icon: '⚖️', description: 'Convert Nepal gold weight instantly between Tola, Lal, Aana and Gram.', category: 'market', isNepal: true, isHot: true, keywords: ['gold converter nepal', 'tola to gram', 'lal to gram'] },
  ...
  { id: 'live-silver-price', slug: 'market-rates/silver-price-nepal', name: 'Live Silver Price', icon: '🥈', description: 'Track today\'s official Live Silver Price in Nepal including Chandi rates per tola, gram and kilogram.', category: 'market', isNepal: true },
  { id: 'historical-gold-silver-rates', slug: 'market-rates/history', name: 'Gold & Silver Price History', icon: '📈', description: 'Verified historical data of gold and silver market rates in Nepal from FENEGOSIDA.', category: 'market', isNepal: true, isNew: true },
  { id: 'silver-converter', slug: 'silver-converter', name: 'Silver Converter', icon: '🥈', description: 'Convert silver between Nepalese and international units while calculating live silver value.', category: 'market', isNepal: true, keywords: ['silver converter', 'chandi converter', 'tola to gram silver'] },
  ...
  // ==========================================
  // FINANCE & BANKING PILLAR — ordered by traffic
  // SIP (12), Property Reg above in Nepal, Loan EMI (1), Compound Interest (8), FD (2), Simple Interest (6), Savings (3), CAGR (0)
  // ==========================================
  ...
  // ==========================================
  // ENGINEERING PILLAR — ordered by traffic
  // 3D Visualizer (148), Engineering GPA (49), Scientific Calc (29), Matrix (3), Graphing, Physics, etc.
  // ==========================================
  { id: '3d-visualizer', slug: 'engineering/3d', name: '3D Surface Plotter', icon: '🧊', description: 'Advanced 3D surface plotter for z=f(x,y) functions with interactive Orbit Camera and Wireframe Mode.', category: 'engineering', isHot: true },
  ...
  // ==========================================
  // HEALTH & FITNESS PILLAR — ordered by traffic
  // Momo Calorie (55), Calorie (22), BMI (2), BMR (0), Body Fat (0), etc.
  // ==========================================
  { id: 'momo-calorie-counter', slug: 'momo-calorie-counter', name: 'Momo Calorie Counter', icon: '🥟', description: 'Calculate nutritional composition of standard momo varieties.', category: 'health', isHot: true },
  ...
  // ==========================================
  // EDUCATION & MATH PILLAR — ordered by traffic
  // Engineering GPA (49), SEE GPA (18 - in Nepal), Date Duration (18), Fraction (1), Linear Solver (1), GPA (8), CGPA (1)
  // ==========================================
  { id: 'engineering-gpa', slug: 'engineering-gpa', name: 'Engineering GPA', icon: '📐', description: 'GPA calculator for engineering degree grading systems.', category: 'education', isHot: true },
  ...
  // ==========================================
  { id: 'date-duration', slug: 'date-duration', name: 'Date Calculator', icon: '📅', description: 'Calculate time delta in days between arbitrary dates.', category: 'utility', isHot: true },
...
export const CATEGORIES: Category[] = [
  // Order by traffic dominance from Search Console data
