...
export const CALCULATORS: Calculator[] = [
  ...
  { id: 'see-gpa', slug: 'see-gpa', name: 'SEE GPA Calculator', icon: '🅰️', description: 'Calculate SEE grade with all subject marks. Updated for 2082/2083 results.', category: 'nepal', isNepal: true, isNew: true, keywords: ['SEE Result 2082', 'SEE Result 2083', 'NEB grading system', 'SEE marks to GPA', 'GPA to percentage Nepal', 'see.ntc.net.np results'] },
