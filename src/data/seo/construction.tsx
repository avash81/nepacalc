...
export const constructionSEO: Record<string, SEOContent> = {
  'concrete-mix': {
    title: "Concrete Mix Calculator | M20, M25 Cement, Sand & Aggregate Lab",
    description: "Institutional resource for concrete volume and mix ratio auditing. Calculate cement bags, sand volume, and aggregate requirements for slabs, beams, and columns. 1500+ words on grade precision.",
    ...
    howToUse: {
      steps: [
        ...
        "6. Water-Cement Ratio Sync: Audit the required water volume for optimal hydration without compromising strength.",
        "7. Unit Conversion: Toggle between Metric (m³) and Imperial (ft³) for local procurement parity.",
        "8. Result Audit: Verify the total volumetric requirement against your bill of quantities (BOQ)."
      ]
    },
    
    formula: {
      title: "The Volumetric Hydration Axiom",
    ...
    content: (
        ...
        Structural Integrity Executive Summary
        </h2>
        <p className="text-slate-800 text-base leading-relaxed">
        Concrete is the literal foundation of modern infrastructure. From residential housing in Kathmandu to large-scale hydropower projects, the ability to accurately audit <strong>Concrete Mix Proportions</strong> is an institutional requirement for structural safety. In <strong>FY 2082/83</strong>, adherence to international building codes (IS 456) has become a mandatory compliance for municipal building approvals in Nepal. This <a href="/calculator/concrete-mix" className="text-slate-600 hover:text-slate-900 underline font-semibold transition-colors">Concrete Lab</a> provides a high-precision engine for calculating the exact ratio of cement, sand, and aggregate. By utilizing the 1.54 dry-volume constant, we eliminate the procurement errors that lead to weak structures or excessive material waste. Whether you are casting a roof slab or a retaining wall, volumetric precision is the primary auditor of construction quality.
        </p>
        </div>
        {/* ==========================================
        ...
        1. Concrete Grade Taxonomy: Auditing Strength Slabs
        </h3>
        ...
        <p className="text-sm text-slate-300"><strong className="text-white">Cement Audit:</strong> Calculated in 50kg bags. Ensure you verify the 'OPC' vs 'PPC' type for your specific curing timeline.</p>
        </div>
        <div className="flex items-start gap-4">
        ...
        <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest mb-3">Institutional Advice</h4>
        <p className="text-xs text-slate-400 leading-relaxed italic">
        "In the high-seismic zones of Nepal, never compromise on the water-cement ratio. Excessive water makes the concrete easier to pour but significantly reduces the ultimate load-bearing capacity. Audit your mix design in our <a href="/calculator/scientific-calculator" className="text-slate-400 underline font-bold">Scientific Lab</a> for high-precision water volume."
        </p>
        </div>
        </div>
        </section>
        ...
        <section>
        <h3 className="text-2xl font-black text-slate-900 mb-6">
        Construction Intelligence Silo
        </h3>
        ...
        Concrete achieves 70% strength in 7 days and 99% in 28 days. Proper water curing is an institutional requirement to prevent thermal cracking.
        </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-blue-300 transition-all">
        <h4 className="font-black text-slate-900 mb-3 flex items-center gap-2">
        <span className="text-blue-500">📐</span> Formwork Audit
        </h4>
        <p className="text-xs text-slate-600 leading-relaxed">
        ...
        Compliance Audit: Last updated Baishakh 2083 (May 2026 . Calculations adhere to IS 456:2000 and Nepal National Building Code (NBC) structural standards.
    ...
    faqs: [
      ...
      { question: "What is the standard ratio for residential slabs in Nepal?", answer: "The standard institutional ratio for residential slabs is M20 (1 part Cement : 1.5 parts Sand : 3 parts Stone Aggregate)." },
  ...
  'brick-calculator': {
    title: "Brick Calculator | Wall Material & Mortar Auditor",
    description: "Institutional resource for estimating brick count and mortar volume. Calculate bricks for 4-inch and 9-inch walls with local Nepal brick dimensions. 1500+ words.",
    ...
    howToUse: {
      steps: [
        ...
        "8. Result Audit: Verify the procurement list against your site inventory to prevent stock-outs."
      ]
    },
    
    formula: {
      title: "The Masonry Volumetric Axiom",
    ...
    content: (
        ...
        Masonry Intelligence Executive Summary
        </h2>
        <p className="text-slate-800 text-base leading-relaxed">
        Brick masonry remains the primary structural and aesthetic medium for residential development in Nepal. From the iconic red-brick facades of Lalitpur to the reinforced partition walls of Kathmandu apartments, auditing <strong>Material Volume</strong> is an institutional requirement for fiscal discipline. In <strong>FY 2082/83</strong>, rising material costs in the Terai and Hilly regions make precision auditing more critical than ever. This <a href="/calculator/brick-calculator" className="text-orange-600 hover:text-orange-800 underline font-semibold transition-colors">Brick Auditor</a> provides a high-precision engine for calculating the exact number of bricks and mortar components required. By utilizing local dimensional standards, we eliminate the 'Procurement Gap' that leads to project delays and unnecessary logistics costs.
        </p>
        </div>
        {/* ==========================================
        ...
        <p className="text-xs text-slate-600 leading-relaxed">Standard for interior partition walls. They save space and reduce the total dead-load on the RCC frame. The auditor estimates approx 5.25 bricks per square foot for these segments.</p>
        </div>
        </div>
        </div>
        </section>
        ...
        <h3 className="text-xl font-black mb-6 flex items-center gap-3 relative z-10">
        <span className="text-orange-400">🧱</span> The Mortar Axiom: Binding the Structure
        </h3>
        <p className="text-sm text-slate-300 leading-relaxed mb-8 relative z-10">
        Bricks only provide strength when bonded with a high-quality mortar mix. In Nepal, a <strong>1:4</strong> or <strong>1:6</strong> (Cement:Sand ratio) is the institutional standard for masonry work. This <a href="/calculator/brick-calculator" className="text-orange-400 underline font-bold">Masonry Lab</a> calculates the dry volume of mortar required per 1000 bricks.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
        <div className="space-y-4">
        <div className="flex items-start gap-4">
        ...
        <p className="text-sm text-slate-300"><strong className="text-white">Joinery Audit:</strong> 10mm to 12mm mortar joints are essential for structural flexibility during minor seismic tremors.</p>
        </div>
        <div className="flex items-start gap-4">
        ...
        <div className="bg-slate-800/50 border border-slate-700 p-6 rounded-xl">
        <h4 className="text-xs font-black text-orange-400 uppercase tracking-widest mb-3">Institutional Advice</h4>
        <p className="text-xs text-slate-400 leading-relaxed italic">
        "For superior finish and structural bonding, always 'Drench' your bricks in water before laying. Dry bricks will suck the moisture out of the mortar, leading to brittle joints and structural cracks. For plastering requirements, synchronize your wall area with our <a href="/calculator/paint-cost" className="text-orange-400 underline font-bold">Paint Lab</a>."
        </p>
        </div>
        </div>
        </section>
        ...
        <p className="text-xs text-slate-600 leading-relaxed">
        The indentation on a brick is called a 'Frog'. It should always face upwards during laying to create a 'Key' for the mortar, ensuring institutional bonding strength.
        </p>
        </div>
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:border-blue-300 transition-all">
        <h4 className="font-black text-slate-900 mb-3 flex items-center gap-2">
        ...
        <p className="text-xs text-slate-600 leading-relaxed">
        Masonry walls must be anchored with horizontal RCC bands at the sill and lintel levels. Audit these voids using the 'Opening Deduction' feature in our engine.
        </p>
        </div>
        </div>
        </section>
        ...
        <div className="pt-10 border-t border-slate-200 text-center mt-12">
        <p className="text-[11px] text-slate-400 italic bg-slate-50 inline-block px-6 py-2 rounded-full border border-slate-100">
        Compliance Audit: Last updated Jestha 2083 (June 2026) . Calculations are based on standard Nepali brick dimensions (9" x 4.5" x 2.25" and standard mortar volumes.
    ...
    faqs: [
      ...
      { question: "What is the standard size of a brick in Nepal?", answer: "The standard institutional size is 9 inches (length) x 4.5 inches (width) x 2.25 inches (height), though local kiln variations exist." },
      ...
      { question: "Do I need to deduct windows from my brick count?", answer: "Yes. Our auditor allows you to subtract the square footage of doors and windows to prevent over-ordering materials." },
