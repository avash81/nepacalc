...
export const marketRatesSEO: Record<string, SEOContent> = {
  'market-rates/live-gold-price': {
    ...
    content: (
        ...
        <div className="space-y-16 font-sans">
            ...
            <div className="bg-[#0f172a] text-white rounded-[2.5rem] p-12 border border-slate-800 shadow-2xl relative overflow-hidden">
                ...
                <a href="/market-rates/silver-price-nepal/" className="text-indigo-600 hover:text-indigo-800 underline font-semibold transition-colors mr-4">Live Silver Price Calculator</a>
            ...
            <section className="space-y-8 mt-12">
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm" key={1}>
                    ...
                    <p className="text-slate-600 leading-relaxed">1 Tola of gold is equal to exactly 11.664 grams. Official regulatory standards and data benchmarks are frequently aligned with references from the <a href="https://fenegosida.org/" target="_blank" rel="dofollow noopener" className="text-blue-600 hover:text-blue-800 underline transition-colors">Federation of Nepal Gold and Silver Dealers</a>.</p>
                </div>
    ...
    faqs: [
      ...
      { question: "What is 1 Tola of gold in grams?", answer: "1 Tola of gold is equal to exactly 11.664 grams." },
  ...
  'market-rates/silver-price-nepal': {
        ...
        <div className="space-y-16 font-sans">
            ...
            <section className="space-y-8 mt-12">
                ...
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm" key={1}>
                    ...
                    <p className="text-slate-600 leading-relaxed">1 Tola of silver equals exactly 11.664 grams. If you find this useful, checking out <a href="/calculator/nepal-stocks/" className="text-blue-600 hover:text-blue-800 underline transition-colors">the nepse stock calculator</a> can provide further context.</p>
                </div>
                <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100 shadow-sm" key={2}>
    ...
    faqs: [
      ...
      { question: "What is the weight of 1 Tola of silver in grams?", answer: "1 Tola of silver equals exactly 11.664 grams." },
