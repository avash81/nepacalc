...
export const educationSEO: Record<string, SEOContent> = {
  'see-gpa': {
    title: "SEE GPA Calculator | Grade & Performance Auditor",
    description: "The definitive systematic resource for NEB SEE grading in FY 2082/83. 1500+ words on GPA logic, letter grading scales, and academic auditing.",
    howToUse: {
      steps: [
        "1. Subject Entry: Select the subject from the dropdown menu (English, Math, Science, etc.).",
        "2. Score Input: Enter the Theory and Practical marks for the 2082/83 session.",
        "3. Weightage Sync: The engine automatically applies the credit hour weights.",
        "4. Grade Conversion: The system maps raw scores to the NEB 9-point scale.",
        "5. GPA Calculation: Total Grade Points are divided by total credit hours.",
        "6. Percentage Calibration: View the equivalent percentage alongside the result.",
        "7. Subject Selection: Add or remove subjects to match your specific stream.",
        "8. Result Audit: Review the final grade sheet for accuracy."
      ]
    },
    formula: {
      title: "The GPA Calculation Axiom",
      description: "GPA is the weighted average of grade points earned in the 2082/83 academic cycle.",
      raw: "GPA = Σ(Grade Point * Credit Hour) / Σ(Credit Hour)",
      variables: ["Grade Point = Numeric value assigned to letter grades.", "Credit Hour = The weight assigned to each subject's importance."]
    },
    content: (
        <div className="space-y-12">
            ...
            <div className="bg-indigo-50/50 border-l-4 border-indigo-600 rounded-r-xl p-8 shadow-sm">
                <h2 className="text-indigo-700 font-black text-xs uppercase tracking-[0.3em] mb-3">
                    Academic Intelligence & Grade Auditing Summary
                </h2>
                <p className="text-slate-800 text-base leading-relaxed">
                    The Secondary Education Examination (SEE) is the definitive auditor of academic progress for millions of students in Nepal. In <strong>FY 2082/83</strong>, the transition to a letter-grading system requires a sophisticated mathematical approach to understand relative performance. This <strong>SEE GPA Auditor</strong> provides a high-precision engine for calculating your Grade Point Average based on official <strong>NEB (National Examination Board)</strong> standards. By accurately weighting theory and practical components, we ensure your academic benchmarking is beyond reproach.
                </p>
            </div>

            {/* Section 1: The NEB 9-Point Taxonomy */}
            <section>
                <h3 className="text-2xl font-black text-slate-900 mb-6">
                    1. The NEB Letter Grading Taxonomy: A Comparative Audit
                </h3>
                <div className="prose prose-slate max-w-none text-slate-600 leading-relaxed space-y-6">
                    <p>
                        The current NEB grading scale for 2082/83 is a 9-point system that maps percentage ranges to specific Grade Points (GP). Understanding the 'cut-off' points is critical for students aiming for scholarships or specific stream admissions (Science vs. Management). Our engine automates this mapping to prevent calculation drift.
                    </p>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                        <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm text-center hover:border-indigo-500 transition-all">
                            <div className="text-2xl font-black text-indigo-600">A+</div>
                            <div className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">90% - 100%</div>
                            <div className="text-xs font-black text-slate-900 mt-1">4.0 Grade Point</div>
                        </div>
                        <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm text-center hover:border-indigo-500 transition-all">
                            <div className="text-2xl font-black text-blue-600">A</div>
                            <div className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">80% - 89%</div>
                            <div className="text-xs font-black text-slate-900 mt-1">3.6 Grade Point</div>
                        </div>
                        <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm text-center hover:border-indigo-500 transition-all">
                            <div className="text-2xl font-black text-emerald-600">B+</div>
                            <div className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">70% - 79%</div>
                            <div className="text-xs font-black text-slate-900 mt-1">3.2 Grade Point</div>
                        </div>
                        <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-sm text-center hover:border-indigo-500 transition-all">
                            <div className="text-2xl font-black text-orange-600">B</div>
                            <div className="text-[10px] text-slate-400 uppercase font-bold tracking-widest">60% - 69%</div>
                            <div className="text-xs font-black text-slate-900 mt-1">2.8 Grade Point</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="bg-slate-900 text-white rounded-2xl p-8 border border-slate-800 shadow-xl overflow-hidden relative">
                ...
                <h3 className="text-xl font-black mb-6 flex items-center gap-3 relative z-10 text-indigo-400">
                    🛡️ Strategic Audit: Theory vs. Practical Weighting
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                    <p className="text-sm text-slate-300 leading-relaxed">
                        In 2082/83, most core subjects (Science, Social, Computer) feature a <strong>75/25 split</strong> between theory and practical assessments. A high practical score can significantly buffer a moderate theory performance, but failing the practical component often results in an overall 'Non-Graded' (NG) status.
                    </p>
                    <div className="bg-slate-800/50 border border-slate-700 p-6 rounded-xl">
                        <h4 className="text-[10px] font-black text-indigo-400 uppercase tracking-widest mb-3">Institutional Advice: The Credit Hour Axiom</h4>
                        <p className="text-xs text-slate-400 leading-relaxed italic">
                            "GPA is not a simple average of grades. It is a weighted average where subjects like Mathematics and Science carry more <strong>Credit Hours</strong> (e.g., 4 or 5) than optional electives. Focus your 2082/83 study schedule on high-weight subjects for maximum GPA delta."
                        </p>
                    </div>
                </div>
            </section>

            {/* Section 3: Step-by-Step Calculation Logic */}
            <section className="bg-white border border-slate-200 rounded-2xl p-8 shadow-sm">
                <h3 className="text-xl font-black text-slate-900 mb-6 flex items-center gap-3">
                    <span className="text-indigo-600">🧮</span> The GPA Resolution Algorithm
                </h3>
                <div className="space-y-6">
                    {[
                        { s: 'Data Collection', d: 'Enter marks for all 8 subjects. Ensure practical marks are correctly assigned to the laboratory component.' },
                        { s: 'Grade Point Mapping', d: 'The system converts raw percentages (e.g., 82%) into the corresponding Grade Point (e.g., 3.6).' },
                        { s: 'Weighted Summation', d: 'Multiply each GP by its subject-specific credit hours to get Weighted Grade Points (WGP).' },
                        { s: 'Final Aggregate', d: 'Divide the total WGP by the total credits attempted (usually 32 for a standard SEE student).' }
                    ].map((step, i) => (
                        <div key={i} className="flex gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                            <div className="w-10 h-10 rounded-full bg-indigo-600 text-white flex items-center justify-center font-black shrink-0">{i+1}</div>
                            <div>
                                <h5 className="font-bold text-slate-900 text-sm mb-1">{step.s}</h5>
            ...
            {/* Section 4: Academic Table */}
            <section>
                <h3 className="text-xl font-black text-slate-900 mb-6">Subject Weighting Matrix: FY 2082/83</h3>
                <div className="overflow-hidden rounded-xl border border-slate-200 shadow-sm">
                    <table className="w-full text-left text-sm">
                        <thead className="bg-slate-50 text-slate-900 font-black">
                            <tr className="border-b border-slate-200">
                                <th className="p-4">Subject Domain</th>
                                <th className="p-4">Credit Hours</th>
                                <th className="p-4">Grading Priority</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-slate-100 text-slate-600">
                            <tr>
                                <td className="p-4 font-bold">Mathematics & Science</td>
                                <td className="p-4">4.0 / 5.0</td>
                                <td className="p-4 text-red-600 font-bold">Critical (High Weight)</td>
                            </tr>
                            <tr>
                                <td className="p-4 font-bold">English & Nepali</td>
                                <td className="p-4">4.0</td>
                                <td className="p-4 text-blue-600 font-bold">High (Linguistic Anchor)</td>
                            </tr>
                            <tr>
                                <td className="p-4 font-bold">Electives / Computer</td>
                                <td className="p-4">2.0 / 3.0</td>
                                <td className="p-4 text-emerald-600 font-bold">Moderate (GPA Booster)</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <section className="bg-indigo-600 text-white p-10 rounded-3xl shadow-2xl relative overflow-hidden">
                ...
                <h3 className="text-2xl font-black mb-4">Post-SEE Academic Auditing</h3>
                <p className="text-indigo-100 leading-relaxed mb-6">
                    A high GPA in the 2082/83 SEE is the gateway to the <strong>+2 Science stream</strong> and engineering/medical prerequisites in Nepal. By auditing your grades early, you can identify subjects that need remedial focus. Remember, many top-tier colleges in Kathmandu require a minimum GPA of 3.2 (B+) for entrance eligibility.
                </p>
                <div className="flex gap-4">
                    <a href="/calculator/gpa" className="bg-white text-indigo-600 px-6 py-2 rounded-full font-black text-xs uppercase tracking-widest hover:bg-indigo-50 transition-colors">Audit +2 GPA</a>
                    <a href="/calculator/cgpa" className="border border-white/30 text-white px-6 py-2 rounded-full font-black text-xs uppercase tracking-widest hover:bg-white/10 transition-colors">Cumulative Lab</a>
                </div>
            </section>
            ...
            <div className="text-center pt-8 border-t border-slate-200">
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.5em]">
                    Academic Performance Auditor • 2082/83 NEB Edition
                </p>
            </div>
        </div>
    ),
    faqs: [
      { question: "How is SEE GPA calculated?", answer: "By multiplying the grade point of each subject by its credit hours and dividing by the total credits for the 2082/83 session." }
    ]
  },
