      ...
      <div className="bg-gray-50 border border-gray-200 rounded-[2.5rem] p-10 flex flex-col md:flex-row items-center gap-10">
         ...
         <div className="flex-1 space-y-2">
            ...
            <p className="text-gray-500 text-sm font-medium leading-relaxed">
               While physical calculators are indispensable for proctored exams (SAT/ACT), Equaly provides high-precision digital versions of these same algorithms for study and professional work — ensuring you have the exact computational power you need, whenever you have an internet connection.
            </p>
         </div>
      </div>
    </div>
