          ...
          {recent.map((item, idx) => (
            <div key={idx} className="group relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center rounded-full hover:bg-[#D93025] hover:text-white text-[#70757A] opacity-0 group-hover:opacity-100 transition-all"
