    ...
    nepal: (
        <div className="space-y-12 text-[#4d5156] leading-relaxed">
          ...
          <section>
             ...
             <p className="mb-6">
               NepaCalc isn't just a website; it's a social utility. We understand that filing your <Link href="/calculator/nepal-income-tax/" className="text-[#1a0dab] underline font-bold">Income Tax</Link> or checking your <strong>SEE GPA</strong> can be stressful. Our mission is to remove that friction by providing clear, step-by-step auditing tools that you can trust. The <Link href="/income-tax/nepal-income-tax-slab-2083-84/" className="text-[#1a0dab] underline font-bold">Nepal Income Tax Slab 2083/84</Link> guide explains the latest FY 2083/84 IRD slabs including SSF exemption, EPF deductions and the female employee rebate.
             </p>
             <p className="mb-6">
