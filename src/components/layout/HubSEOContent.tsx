...
export const HubSEOContent: React.FC<HubContentProps> = ({ category }) => {
  const contents = {
    home: (
      <div className="space-y-12 text-[#4d5156] leading-relaxed">
        <section>
          ...
          <p className="mb-6">
            In the rapidly digitizing landscape of 2081 BS, access to precision mathematical tools is no longer a luxury but a fundamental necessity for students, professionals, and entrepreneurs across Nepal. <strong>NepaCalc</strong> was founded on the principle of institutional accuracy—combining high-performance cloud computing with local legislative compliance. Our platform serves as the digital heartbeat for financial auditing, educational excellence, and engineering precision in the Himalayan region.
          </p>
          <p className="mb-6">
    ...
    finance: (
      <div className="space-y-12 text-[#4d5156] leading-relaxed">
        <section>
          <h2 className="text-3xl font-black text-[#202124] mb-6">Professional Financial Auditing in Nepal: A 2081 BS Perspective</h2>
          <p className="mb-6">
