          ...
          <div className="w-full lg:w-[320px] space-y-8 no-print">
            ...
            <div className="bg-white border border-[#DADCE0] rounded-lg shadow-sm p-6">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <a href={`https://api.whatsapp.com/send?text=Check out this NEA Bill Calculator: Current Electricity Tariffs`} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1.5 p-2 rounded-md bg-[#E7F8ED] hover:bg-[#25D366] hover:text-white transition-all text-[#25D366]">
                ...
                <a href={`https://twitter.com/intent/tweet?text=Check out this NEA Bill Calculator: Current Electricity Tariffs`} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1.5 p-2 rounded-md bg-[#F1F1F1] hover:bg-black hover:text-white transition-all text-black">
