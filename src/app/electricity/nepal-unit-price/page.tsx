    ...
    <>
      ...
      <div className="bg-[#F1F3F4] min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          {/* ── NEA BILLING HUB NAVIGATION ── */}
          <div className="bg-[#003087] rounded-xl p-5 mb-8">
            <p className="text-white font-black text-sm mb-3">⚡ NEA Billing Hub</p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              {[
                { label: "NEA Bill Calculator", href: "/calculator/nea-bill/", active: false },
                { label: "Electricity Unit Price", href: "/electricity/nepal-unit-price/", active: true },
                { label: "NEA Tariff Rates", href: "/blog/nea-tariff-rates-2083-84/", active: false },
                { label: "Solar Calculator", href: "/calculator/solar-requirement/", active: false },
              ].map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`text-xs font-semibold px-3 py-2 rounded-lg text-center transition-colors ${item.active ? 'bg-white text-[#003087]' : 'bg-white/10 text-white hover:bg-white/20'}`}
                >
          ...
          <section id="cost-examples" className="mb-10">
            <h2 className="text-2xl font-black text-[#202124] mb-6">Electricity Cost Examples (5A Meter)</h2>
