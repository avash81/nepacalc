    ...
    <>
      <JsonLd 
        ...
        data={{
          ...
          breadcrumbUrl: "https://nepacalc.com/electricity/nea-tariff-rates/",
          breadcrumb: [
            { name: "Home", item: "https://nepacalc.com" },
            { name: "Electricity Guides", item: "https://nepacalc.com/electricity/" },
            { name: "NEA Tariff Rates", item: "https://nepacalc.com/electricity/nea-tariff-rates/" }
          ],
          webpage: {
            url: "https://nepacalc.com/electricity/nea-tariff-rates/",
          ...
          faqs: [
            {
              question: "What are the latest NEA tariff rates for 2083/84?",
              answer: "The latest NEA tariff rates for 2083/84 range from Rs. 3.00 to Rs. 11.00 per unit depending on your monthly electricity consumption slab and meter capacity (e.g., 5A, 15A, 30A). A fixed monthly service charge is also applied."
            },
            {
              question: "What is the current NEA electricity rate in Nepal?",
              answer: "The current NEA electricity rate in Nepal operates on a progressive slab system. For a standard 5A residential meter, it starts at Rs. 3.00 per unit for lower usage and goes up to Rs. 11.00 per unit for usage above 250 units."
            },
            {
              question: "How are NEA service charges calculated?",
              answer: "NEA service charges are fixed monthly fees based on your connection's ampere capacity and your total monthly electricity consumption slab. You pay a single flat service charge fee at the end of the month, ranging from Rs. 30 to Rs. 250."
            },
            {
              question: "How does the NEA Bill Calculator use tariff rates?",
              answer: "The NEA Bill Calculator accurately applies the official progressive slab rates, fixed service charges, and concessional VAT rules based on your exact consumed units and meter capacity to generate an itemized bill breakdown."
            },
            {
              question: "What is the lifeline tariff in Nepal?",
              answer: "The lifeline tariff is a special concession for low-income households using a 5A meter. If you consume 20 units or less per month, you pay no energy charge (Rs. 0 per unit) and only a minimum service charge of Rs. 30."
            },
            {
              question: "Are the NEA tariff rates the same across all of Nepal?",
              answer: "Yes, the domestic electricity tariff in Nepal is uniform across the country."
            },
            {
              question: "What is the difference between service charge and demand charge?",
              answer: "For residential customers, NEA applies a service charge, which is a fixed monthly fee based on your meter capacity and consumption slab. A demand charge (based on kVA) is typically applied to commercial, industrial, or bulk consumers rather than standard domestic households."
            }
          ]
        }} 
      />
