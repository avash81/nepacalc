...
export default function MarksNeededCalculator() {
  ...
  return (
    <ModernCalcLayout
      ...
      faqs={[
        { question: "What does mathematically impossible mean?", answer: "If the result is over 100%, it means that even if you score a perfect 100% on the final exam, the exam isn't worth enough points to pull your overall grade up to your target." },
        { question: "What if my target is lower than my current grade?", answer: "The calculator will show a low percentage. If the result is 0%, it means you have already locked in your target grade regardless of what you score on the final." }
      ]}
