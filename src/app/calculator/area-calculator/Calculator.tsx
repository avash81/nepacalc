...
export default function AreaCalculator() {
  ...
  return (
    <ModernCalcLayout
      ...
      faqs={[
        { question: "What is Area?", answer: "Area is the quantity that expresses the extent of a two-dimensional figure or shape in the plane. It is always measured in square units." }
      ]}
