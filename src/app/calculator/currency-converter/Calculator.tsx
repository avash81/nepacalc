...
export default function CurrencyCalculator({ isEmbed = false }: { isEmbed?: boolean }) {
  ...
  return (
    <ModernCalcLayout
      ...
      faqs={[
        { question: "Is the INR to NPR rate fixed?", answer: "Yes, the Nepalese Rupee is pegged to the Indian Rupee at a fixed exchange rate of ₹100 INR = Rs. 160 NPR. This rate does not fluctuate." },
        { question: "Are these buying or selling rates?", answer: "These are mid-market rates meant for estimation and general conversion. Commercial banks in Nepal will have slight variations between their buying and selling rates." }
      ]}
