  ...
  return (
    <div className="bg-[#F1F3F4]">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p className="p-4 bg-emerald-50 border-l-4 border-emerald-500 rounded-r-lg text-slate-700 mt-4"><strong>EV Owners:</strong> If you use your home electricity to charge an EV, make sure you stay updated on annual vehicle registration. Read our <Link href="/guide/bluebook-renewal-nepal/" className="text-blue-600 hover:underline">Complete Guide to Bluebook Renewal in Nepal</Link> for detailed instructions and penalty rules.</p>
