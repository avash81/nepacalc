...
export const metadata: Metadata = {
  ...calcMeta({
    title: 'Momo Calorie Calculator – Chicken, Veg, Fried & Steamed Momos',
    description:
  ...
  openGraph: {
    ...
    description:
      'Estimate calories in chicken, veg, steamed, fried and jhol momos instantly.',
...
const webPageSchema = {
  ...
  url: 'https://nepacalc.com/calculator/momo-calorie-counter/',
  name: 'Momo Calorie Calculator – Chicken, Veg, Fried & Steamed Momos',
  headline: 'Momo Calorie Calculator',
  description:
    'Calculate calories in chicken, veg, fried, steamed, paneer and buff momos instantly. Estimate calories per piece or plate with a full nutritional breakdown.',
  inLanguage: 'en',
...
// ─── Schema: FAQPage (4 core questions only) ──────────────────────────────────
const faqSchema = {
  '@context': 'https://schema.org',
  '@type': 'FAQPage',
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'One steamed chicken momo contains approximately 45–60 calories depending on size, filling and wrapper thickness.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Fried momos absorb cooking oil and contain significantly more calories than steamed momos. Fried chicken momos contain approximately 85 kcal per piece.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'A standard plate of 8–10 steamed chicken momos contains approximately 480–600 calories depending on serving size and filling.',
      },
    },
    {
      '@type': 'Question',
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Steamed vegetable momos have the lowest calorie count at approximately 45 calories per piece.',
      },
    },
  ],
};
