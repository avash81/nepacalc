        ...
        <section className="pt-2 pb-4 border-b border-[#dadce0] bg-[#F1F3F4]">
          <div className="hp-container">
            <div className="max-w-5xl mx-auto text-center px-4 pt-2">
              ...
              <p className="text-[13px] text-slate-500 max-w-2xl mx-auto mb-6">
                Featured: Check out our new <Link href="/guide/bluebook-renewal-nepal/" className="text-blue-600 hover:underline">Bluebook Renewal in Nepal</Link> comprehensive guide.
              </p>
