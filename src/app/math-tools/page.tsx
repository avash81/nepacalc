  ...
  return (
    <div className="w-full min-h-screen bg-[#F1F3F4] flex flex-col pt-14 relative overflow-hidden">
      ...
      <div className="hp-container relative z-10 pt-10 pb-8 text-center text-pretty">
         ...
         <h1 className="text-4xl sm:text-7xl font-black text-[#202124] tracking-tighter leading-none mb-6">
            Mathematical <span className="text-[#FFC107] bg-black px-4 py-1.5 rounded-2xl shadow-xl shadow-yellow-500/10">Laboratory</span>
         </h1>
