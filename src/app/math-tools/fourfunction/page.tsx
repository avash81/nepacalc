    ...
    <div className="flex flex-col bg-slate-50 overflow-y-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-200 mt-8 rounded-t-3xl shadow-lg border-t border-slate-200 dark:border-slate-800">
        <section className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <p className="mb-4">
            If you find that your mathematical needs go beyond basic arithmetic, NepaCalc has you covered. You can easily upgrade your toolset by exploring our <a href="/math-tools/calculus/" className="text-teal-600 hover:underline">Calculus & Algebra Laboratory</a> for advanced mathematics, or browse our <a href="/calculator/" className="text-teal-600 hover:underline">Complete Calculator Directory</a> to find specialized tools for finance, engineering, health, and unit conversions tailored for Nepal.
          </p>
