        ...
        <section className="max-w-6xl mx-auto px-6 pb-12">
          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
            {existingTools.map(calc => {
              ...
              return (
                <Link key={calc.name} href={href} className="flex items-center gap-3 px-4 py-3 rounded-xl border border-slate-200 hover:border-[#f72585] hover:bg-[#f7258508] transition-all group min-h-[56px]">
