    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "@type": "FAQPage",
          "mainEntity": [
            { "@type": "Question", "name": "How to use the Finance Calculators Free Tools NepaCal tool?", "acceptedAnswer": { "@type": "Answer", "text": "Simply enter your data and our free finance calculator tool will provide instant results tailored for Nepal." } },
            { "@type": "Question", "name": "Is this Finance Calculators Free Tools NepaCal free?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, NepaCal's Finance Calculators Free Tools NepaCal is 100% free with no registration required." } }
          ]
        }) }}
      />
      <section className="mt-12 bg-white dark:bg-slate-900 rounded-2xl p-6 sm:p-10 border border-slate-200 dark:border-slate-800 shadow-sm">
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">About the Finance Calculators Free Tools NepaCal</h2>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-3">
          Our free <strong>finance calculator</strong> is optimized for Nepalese users. Whether you need an online finance calculator or want to calculate accurately — NepaCal is your best tool.
        </p>
        <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed mb-8">
          Related: <strong>finance calculator</strong>, <strong>refinance calculator</strong>, <strong>calcul finance</strong>, <strong>business finance calculator</strong>, <strong>boat finance calculator</strong>, <strong>business loan finance calculator</strong>.
        </p>
        ...
        <div className="space-y-3">
          <details className="bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50 overflow-hidden" open>
            <summary className="flex items-center gap-3 p-5 cursor-pointer font-semibold text-slate-900 dark:text-white text-sm list-none select-none">
              ...
              <span>How do I use the Finance Calculators Free Tools NepaCal?</span>
            </summary>
          ...
          <details className="bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50 overflow-hidden" open>
            ...
            <div className="px-5 pb-5 text-slate-600 dark:text-slate-400 text-sm leading-relaxed border-t border-slate-100 dark:border-slate-700/50 pt-4">
              Yes, our <strong>finance calculator</strong> is regularly updated to reflect local standards.
            </div>
          </details>
        </div>
      </section>
