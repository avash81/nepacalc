        ...
        <div className="flex items-center justify-between mb-2">
           ...
           <div className="flex items-center gap-4">
              ...
              <button 
                 ...
                 disabled={saving}
                 className="flex items-center gap-2.5 bg-emerald-600 hover:bg-emerald-700 text-[#202124] px-8 py-3 rounded-2xl font-black text-[11px] uppercase tracking-widest shadow-sm shadow-emerald-500/20 active:scale-95 transition-all disabled:opacity-50"
              >
                 {saving ? (
          ...
          <div className="lg:col-span-4 space-y-8">
               ...
               <div className="relative z-10 space-y-6">
                  ...
                  <div className="space-y-3">
                     ...
                     <select 
                        ...
                        className="w-full h-12 px-4 rounded-xl border border-[#dadce0] bg-[#f8f9fa] focus:border-emerald-500 outline-none text-[13px] font-bold text-[#202124] shadow-inner appearance-none custom-select"
                     >
                  ...
                  <div className="space-y-3">
                     ...
                     <textarea 
                        ...
                        className="w-full h-28 p-4 rounded-xl border border-[#dadce0] bg-[#f8f9fa] focus:border-emerald-500 outline-none text-[13px] leading-relaxed text-slate-200 resize-none shadow-inner"
            ...
            <div className="bg-white border border-slate-100 p-8 rounded-lg shadow-sm shadow-slate-200/40">
               ...
               <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                     <label className="block text-[10px] font-black text-emerald-500 uppercase tracking-widest ml-2">Phase 3: Conclusion (Bottom)</label>
                     <input 
                        value={imageBottom} 
