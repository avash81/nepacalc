          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-lg p-10 shadow-sm relative overflow-hidden">
               ...
               <div className="flex items-center gap-3 mb-6 relative z-10">
                  <div className="w-10 h-10 rounded-xl bg-[#1a73e8] flex items-center justify-center text-[#202124] border border-blue-500 shadow-sm shadow-blue-500/20">
               ...
               <div className="relative z-10 space-y-6">
                  {Object.entries(CALC_GROUPS).map(([group, slugs]) => (
                    <div key={group}>
                      <div className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-3 border-b border-[#dadce0] pb-2">
                        {group}
                      </div>
                          ...
                          return (
                            <button key={s} onClick={() => toggleCalc(s)}
                              className={clsx(
                                ...
                                selected ? "bg-[#1a73e8] text-[#202124] shadow-sm shadow-blue-500/20 scale-105" : "bg-[#f8f9fa] text-slate-400 border border-[#dadce0] hover:border-white/30 hover:bg-white/10"
                              )}>
                              {calc.name}
                            </button>
                          );
               ...
               {relatedCalcs.length > 0 && (
                  <div className="mt-8 pt-4 border-t border-[#dadce0] relative z-10">
