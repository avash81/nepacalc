      ...
      >
        <div className="prose prose-slate max-w-none">
          <p className="lead text-xl text-slate-600 mb-8 border-l-4 border-yellow-500 pl-4 bg-yellow-50/50 py-4 rounded-r-xl">
            ...
            <Link href="/calculator/gold-price/">NepaCalc live gold price calculator</Link> to verify today&apos;s rate in real time.
          </p>
          ...
          <p>
            Use our <Link href="/calculator/gold-price/"><strong>Nepal Gold Price Calculator</strong></Link> to compute the exact cost including making charges and VAT for any gold weight and karat.
          </p>
          ...
          <div className="mt-12 p-8 bg-[#1A1A2E] rounded-2xl text-white not-prose">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Link href="/calculator/gold-price/" className="flex items-center justify-between p-4 bg-white/10 rounded-xl hover:bg-white/20 transition-all text-white no-underline font-bold">
