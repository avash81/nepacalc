...
export const metadata = calcMeta({
  ...
  description: 'Accurate IRD tax calculator, VAT calculator Nepal, and salary tax calculator. Avoid VAT fine in Nepal with precise 13% VAT return calculation for FY 2083/84.',
