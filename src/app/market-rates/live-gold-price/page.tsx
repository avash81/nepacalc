...
export async function generateMetadata(): Promise<Metadata> {
  ...
  let priceSnippet = `Check today's live gold price in Nepal. Get official FENEGOSIDA rates for 24K Hallmark and 22K Tejabi gold per tola and 10 grams.`;
  ...
  if (gold24k) {
    ...
    priceSnippet = `Live gold price in Nepal: 24K Hallmark Rs. ${gold24k.toLocaleString('en-IN')} per Tola${tenGramStr}${tejabiStr}. Official FENEGOSIDA gold rate.`;
  }
  ...
  return {
    ...
    twitter: {
      ...
      title: "Gold Price in Nepal Today | Live FENEGOSIDA Rate",
      description,
      images: ['https://nepacalc.com/images/og/gold-price-nepal.jpg']
    },
    alternates: {
          ...
          <div className="flex-1 sr-seo-header">
            ...
            {gold24k && (
              <div className="flex flex-wrap gap-4 text-sm font-semibold text-slate-700 mb-2">
                ...
                {silver && (
                  <div>
                    <span className="text-slate-500 font-medium">Silver (Chandi) per Tola:</span>{' '}
