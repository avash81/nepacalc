...
for cid, name, cat in calculators:
    ...
    internal_links_jsx = " | ".join([f'<Link href="/calculators/{r["slug"]}" className="text-blue-600 hover:underline">{r["name"]}</Link>' for r in data['related']])
    ...
    content: (
      <>
        <div className="nepalc-encyclopedia text-[16px] text-slate-700 leading-relaxed bg-white">
          ...
          <h2 className="text-2xl font-bold mb-6 text-slate-900 border-l-4 border-blue-600 pl-4 uppercase tracking-tight">5. Official Resources & Internal Audit Tools</h2>
          <div className="bg-slate-900 text-white p-10 rounded-[2.5rem] mb-10 shadow-xl">
             <h4 className="text-xl font-bold mb-4 text-blue-400">Sovereign Authority Hub</h4>
             <p className="mb-6 text-slate-300">Official Data Source: <a href="{data['external']['url']}" target="_blank" className="text-blue-400 underline">{data['external']['name']}</a></p>
             <div className="border-t border-slate-700 pt-6">
                <p className="text-xs uppercase tracking-widest text-slate-500 mb-4 font-bold">Related Auditing Tools:</p>
...
print(f"Authority Link Sync Complete: 104 Calculators Deployed with internal/external links.")
